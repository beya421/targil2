...
let tokenizer tokens namespace = 
  ...
  | "call" -> 
    let g = List.hd (List.tl tokens) in 
    let n = List.hd ( List.tl ( List.tl tokens) ) in
    String.concat "\n" [(String.cat"@Return_" g "" ) ;"D=A";"@SP";"A=M";"M=D";"@SP";"M=M+1"
    "@LCL";"D=M";"@SP";"A=M";"M=D";"@SP";"M=M+1";
    "@ARG";"D=M";"@SP";"A=M";"M=D";"@SP";"M=M+1";
    "@THIS";"D=M";"@SP";"A=M";"M=D";"@SP";"M=M+1";
    "@THAT";"D=M";"@SP";"A=M";"M=D";"@SP";"M=M+1";
    "@SP";"D=M";"@newArg";"D=D-A";"@ARF";"M=D";
    "@SP";"D=M";"@LCL";"M=D";
    "@g";"0;JMP";
    "(g.ReturnAddress)"]  
    ...
    "function" -> 
      let g = List.hd (List.tl tokens) in 
      let k = List.hd ( List.tl ( List.tl tokens) ) in
      String.concat "\n" [(String.cat "(Return_" g ")");
      "@k";"D=A";"@f.End";"D:JEQ";"(f.Loop)";"@SP";"A=M";
      "M=0";"@SP";"M=M+1";"@f.Loop";"D=D-1;JNE";"(f.End)"]
